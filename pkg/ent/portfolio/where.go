...
func HasOwners() predicate.Portfolio {
...
func HasOwnersWith(preds ...predicate.User) predicate.Portfolio {
	return predicate.Portfolio(func(s *sql.Selector) {
		step := newOwnersStep()
...
func HasTags() predicate.Portfolio {
	return predicate.Portfolio(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTagsWith(preds ...predicate.Tag) predicate.Portfolio {
	return predicate.Portfolio(func(s *sql.Selector) {
		step := newTagsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
