...
type RuleExecution struct {
	...
	ExecutionSummary    *structpb.Struct `protobuf:"bytes,12,opt,name=execution_summary,json=executionSummary,proto3" json:"execution_summary,omitempty"` // Rule-type specific execution details
...
const file_api_models_rule_execution_proto_rawDesc = "" +
	"\n" +
	"\x1fapi/models/rule_execution.proto\x12\x06models\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xe5\x04\n" +
...
var file_api_models_rule_execution_proto_depIdxs = []int32{
	...
	3, // 3: models.RuleExecution.execution_summary:type_name -> google.protobuf.Struct
