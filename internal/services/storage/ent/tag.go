...
// was not loaded in eager-loading.
func (e TagEdges) PortfoliosOrErr() ([]*Portfolio, error) {
	if e.loadedTypes[1] {
...
// QueryPortfolios queries the "portfolios" edge of the Tag entity.
func (t *Tag) QueryPortfolios() *PortfolioQuery {
	return NewTagClient(t.config).QueryPortfolios(t)
}
