...
type AssetMutation struct {
	...
	clearedprices       bool
	prices_base         map[int]struct{}
	removedprices_base  map[int]struct{}
	clearedprices_base  bool
	transactions        map[int]struct{}
	removedtransactions map[int]struct{}
	clearedtransactions bool
	done                bool
...
func (m *AssetMutation) AddPriceIDs(ids ...int) {
	if m.prices == nil {
...
func (m *AssetMutation) RemovedPricesIDs() (ids []int) {
...
func (m *AssetMutation) PricesIDs() (ids []int) {
...
func (m *AssetMutation) ResetPrices() {
	m.prices = nil
...
func (m *AssetMutation) AddPricesBaseIDs(ids ...int) {
	if m.prices_base == nil {
		m.prices_base = make(map[int]struct{})
	}
	for i := range ids {
		m.prices_base[ids[i]] = struct{}{}
	}
}

// ClearPricesBase clears the "prices_base" edge to the Price entity.
func (m *AssetMutation) ClearPricesBase() {
	m.clearedprices_base = true
}

// PricesBaseCleared reports if the "prices_base" edge to the Price entity was cleared.
func (m *AssetMutation) PricesBaseCleared() bool {
	return m.clearedprices_base
}

// RemovePricesBaseIDs removes the "prices_base" edge to the Price entity by IDs.
func (m *AssetMutation) RemovePricesBaseIDs(ids ...int) {
	if m.removedprices_base == nil {
		m.removedprices_base = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.prices_base, ids[i])
		m.removedprices_base[ids[i]] = struct{}{}
	}
}

// RemovedPricesBase returns the removed IDs of the "prices_base" edge to the Price entity.
func (m *AssetMutation) RemovedPricesBaseIDs() (ids []int) {
	for id := range m.removedprices_base {
		ids = append(ids, id)
	}
	return
}

// PricesBaseIDs returns the "prices_base" edge IDs in the mutation.
func (m *AssetMutation) PricesBaseIDs() (ids []int) {
	for id := range m.prices_base {
		ids = append(ids, id)
	}
	return
}

// ResetPricesBase resets all changes to the "prices_base" edge.
func (m *AssetMutation) ResetPricesBase() {
	m.prices_base = nil
	m.clearedprices_base = false
	m.removedprices_base = nil
}

// AddTransactionIDs adds the "transactions" edge to the Transaction entity by ids.
func (m *AssetMutation) AddTransactionIDs(ids ...int) {
	if m.transactions == nil {
		m.transactions = make(map[int]struct{})
	}
	for i := range ids {
...
// ClearTransactions clears the "transactions" edge to the Transaction entity.
func (m *AssetMutation) ClearTransactions() {
	m.clearedtransactions = true
}

// TransactionsCleared reports if the "transactions" edge to the Transaction entity was cleared.
func (m *AssetMutation) TransactionsCleared() bool {
	return m.clearedtransactions
}

// RemoveTransactionIDs removes the "transactions" edge to the Transaction entity by IDs.
func (m *AssetMutation) RemoveTransactionIDs(ids ...int) {
	if m.removedtransactions == nil {
		m.removedtransactions = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovedTransactions returns the removed IDs of the "transactions" edge to the Transaction entity.
func (m *AssetMutation) RemovedTransactionsIDs() (ids []int) {
	for id := range m.removedtransactions {
		ids = append(ids, id)
	}
	return
...
// TransactionsIDs returns the "transactions" edge IDs in the mutation.
func (m *AssetMutation) TransactionsIDs() (ids []int) {
	for id := range m.transactions {
		ids = append(ids, id)
	}
	return
...
// ResetTransactions resets all changes to the "transactions" edge.
func (m *AssetMutation) ResetTransactions() {
	m.transactions = nil
	m.clearedtransactions = false
	m.removedtransactions = nil
}
...
func (m *AssetMutation) AddedEdges() []string {
	...
	if m.prices != nil {
		edges = append(edges, asset.EdgePrices)
	}
	if m.prices_base != nil {
		edges = append(edges, asset.EdgePricesBase)
	}
	if m.transactions != nil {
		edges = append(edges, asset.EdgeTransactions)
	}
	return edges
}
...
func (m *AssetMutation) AddedIDs(name string) []ent.Value {
	...
	case asset.EdgeHoldings:
		...
		return ids
	case asset.EdgePrices:
		ids := make([]ent.Value, 0, len(m.prices))
		for id := range m.prices {
			ids = append(ids, id)
		}
		return ids
	case asset.EdgePricesBase:
		ids := make([]ent.Value, 0, len(m.prices_base))
		for id := range m.prices_base {
			ids = append(ids, id)
		}
		return ids
	case asset.EdgeTransactions:
		ids := make([]ent.Value, 0, len(m.transactions))
		for id := range m.transactions {
			ids = append(ids, id)
		}
...
func (m *AssetMutation) RemovedIDs(name string) []ent.Value {
	...
	case asset.EdgePrices:
		...
		return ids
	case asset.EdgePricesBase:
		ids := make([]ent.Value, 0, len(m.removedprices_base))
		for id := range m.removedprices_base {
			ids = append(ids, id)
		}
		return ids
...
func (m *HoldingMutation) SetAssetID(i int) {
	m.asset = &i
}

// AssetID returns the value of the "asset_id" field in the mutation.
func (m *HoldingMutation) AssetID() (r int, exists bool) {
	v := m.asset
	if v == nil {
		return
	}
...
// OldAssetID returns the old "asset_id" field's value of the Holding entity.
// If the Holding object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HoldingMutation) OldAssetID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *HoldingMutation) ResetAssetID() {
	m.asset = nil
}
...
func (m *HoldingMutation) SetDecimals(u uint32) {
	m._Decimals = &u
	m.add_Decimals = nil
}

// Decimals returns the value of the "Decimals" field in the mutation.
func (m *HoldingMutation) Decimals() (r uint32, exists bool) {
	v := m._Decimals
	if v == nil {
		return
	}
...
// OldDecimals returns the old "Decimals" field's value of the Holding entity.
// If the Holding object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HoldingMutation) OldDecimals(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *HoldingMutation) AddDecimals(u int32) {
	if m.add_Decimals != nil {
		*m.add_Decimals += u
	} else {
		m.add_Decimals = &u
	}
...
func (m *HoldingMutation) AddedDecimals() (r int32, exists bool) {
	v := m.add_Decimals
	if v == nil {
		return
	}
...
func (m *HoldingMutation) ResetDecimals() {
	m._Decimals = nil
	m.add_Decimals = nil
}

// SetPortfolioID sets the "portfolio_id" field.
func (m *HoldingMutation) SetPortfolioID(i int) {
	m.portfolio = &i
}

// PortfolioID returns the value of the "portfolio_id" field in the mutation.
func (m *HoldingMutation) PortfolioID() (r int, exists bool) {
	v := m.portfolio
	if v == nil {
		return
	}
...
// OldPortfolioID returns the old "portfolio_id" field's value of the Holding entity.
// If the Holding object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HoldingMutation) OldPortfolioID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *HoldingMutation) ClearPortfolioID() {
	m.portfolio = nil
	m.clearedFields[holding.FieldPortfolioID] = struct{}{}
}

// PortfolioIDCleared returns if the "portfolio_id" field was cleared in this mutation.
func (m *HoldingMutation) PortfolioIDCleared() bool {
	_, ok := m.clearedFields[holding.FieldPortfolioID]
	return ok
}

// ResetPortfolioID resets all changes to the "portfolio_id" field.
func (m *HoldingMutation) ResetPortfolioID() {
	m.portfolio = nil
	delete(m.clearedFields, holding.FieldPortfolioID)
}

// SetAccountID sets the "account_id" field.
func (m *HoldingMutation) SetAccountID(i int) {
	m.account = &i
}

// AccountID returns the value of the "account_id" field in the mutation.
func (m *HoldingMutation) AccountID() (r int, exists bool) {
	v := m.account
	if v == nil {
		return
	}
...
// If the Holding object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HoldingMutation) OldAccountID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *HoldingMutation) ClearAsset() {
	m.clearedasset = true
	m.clearedFields[holding.FieldAssetID] = struct{}{}
}
...
func (m *HoldingMutation) PortfolioCleared() bool {
	return m.PortfolioIDCleared() || m.clearedportfolio
}
...
func (m *HoldingMutation) ClearAccount() {
	...
	m.clearedFields[holding.FieldAccountID] = struct{}{}
}
...
func (m *HoldingMutation) Fields() []string {
	...
	if m.asset != nil {
		fields = append(fields, holding.FieldAssetID)
	}
	if m.amount != nil {
		fields = append(fields, holding.FieldAmount)
	}
	if m._Decimals != nil {
		fields = append(fields, holding.FieldDecimals)
	}
	if m.portfolio != nil {
		fields = append(fields, holding.FieldPortfolioID)
	}
	if m.account != nil {
...
func (m *HoldingMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(holding.FieldPortfolioID) {
		fields = append(fields, holding.FieldPortfolioID)
	}
	return fields
}
...
// SetUserID sets the "user_id" field.
func (m *PortfolioMutation) SetUserID(i int) {
	m.user = &i
}

// UserID returns the value of the "user_id" field in the mutation.
func (m *PortfolioMutation) UserID() (r int, exists bool) {
	v := m.user
	if v == nil {
		return
	}
...
// If the Portfolio object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PortfolioMutation) OldUserID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUserID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// SetData sets the "data" field.
func (m *PortfolioMutation) SetData(value map[string]interface{}) {
	m.data = &value
}

// Data returns the value of the "data" field in the mutation.
func (m *PortfolioMutation) Data() (r map[string]interface{}, exists bool) {
	v := m.data
	if v == nil {
		return
	}
...
// OldData returns the old "data" field's value of the Portfolio entity.
// If the Portfolio object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PortfolioMutation) OldData(ctx context.Context) (v map[string]interface{}, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldData is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetData resets all changes to the "data" field.
func (m *PortfolioMutation) ResetData() {
	m.data = nil
}
...
func (m *PortfolioMutation) Fields() []string {
	...
	if m.data != nil {
		fields = append(fields, portfolio.FieldData)
	}
	return fields
}
...
// SetAssetID sets the "asset_id" field.
func (m *PriceMutation) SetAssetID(i int) {
	m.asset = &i
}

// AssetID returns the value of the "asset_id" field in the mutation.
func (m *PriceMutation) AssetID() (r int, exists bool) {
	v := m.asset
	if v == nil {
		return
	}
...
// OldAssetID returns the old "asset_id" field's value of the Price entity.
// If the Price object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PriceMutation) OldAssetID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAssetID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetAssetID resets all changes to the "asset_id" field.
func (m *PriceMutation) ResetAssetID() {
	m.asset = nil
}

// SetBaseAssetID sets the "base_asset_id" field.
func (m *PriceMutation) SetBaseAssetID(i int) {
	m.base_asset = &i
}

// BaseAssetID returns the value of the "base_asset_id" field in the mutation.
func (m *PriceMutation) BaseAssetID() (r int, exists bool) {
	v := m.base_asset
	if v == nil {
		return
	}
...
// OldBaseAssetID returns the old "base_asset_id" field's value of the Price entity.
// If the Price object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PriceMutation) OldBaseAssetID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *PriceMutation) ResetBaseAssetID() {
	m.base_asset = nil
}
...
// SetDecimals sets the "decimals" field.
func (m *PriceMutation) SetDecimals(u uint32) {
	m.decimals = &u
	m.adddecimals = nil
}

// Decimals returns the value of the "decimals" field in the mutation.
func (m *PriceMutation) Decimals() (r uint32, exists bool) {
	v := m.decimals
	if v == nil {
		return
	}
...
// OldDecimals returns the old "decimals" field's value of the Price entity.
// If the Price object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PriceMutation) OldDecimals(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDecimals is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddDecimals adds u to the "decimals" field.
func (m *PriceMutation) AddDecimals(u int32) {
...
// AddedDecimals returns the value that was added to the "decimals" field in this mutation.
func (m *PriceMutation) AddedDecimals() (r int32, exists bool) {
	v := m.adddecimals
	if v == nil {
		return
	}
...
// ResetDecimals resets all changes to the "decimals" field.
func (m *PriceMutation) ResetDecimals() {
	m.decimals = nil
	m.adddecimals = nil
}

// SetLast sets the "last" field.
func (m *PriceMutation) SetLast(i int64) {
	m.last = &i
	m.addlast = nil
}

// Last returns the value of the "last" field in the mutation.
func (m *PriceMutation) Last() (r int64, exists bool) {
	v := m.last
	if v == nil {
		return
	}
...
// OldLast returns the old "last" field's value of the Price entity.
// If the Price object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PriceMutation) OldLast(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *PriceMutation) AddLast(i int64) {
	if m.addlast != nil {
		*m.addlast += i
	} else {
		m.addlast = &i
...
func (m *PriceMutation) AddedLast() (r int64, exists bool) {
	v := m.addlast
	if v == nil {
		return
	}
...
func (m *PriceMutation) ResetLast() {
	m.last = nil
	m.addlast = nil
}
...
func (m *PriceMutation) SetTimestamp(t time.Time) {
	m.timestamp = &t
}

// Timestamp returns the value of the "timestamp" field in the mutation.
func (m *PriceMutation) Timestamp() (r time.Time, exists bool) {
	v := m.timestamp
	if v == nil {
		return
	}
...
// OldTimestamp returns the old "timestamp" field's value of the Price entity.
// If the Price object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PriceMutation) OldTimestamp(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *PriceMutation) ResetTimestamp() {
	m.timestamp = nil
}
...
func (m *PriceMutation) ClearAsset() {
	m.clearedasset = true
	m.clearedFields[price.FieldAssetID] = struct{}{}
}
...
func (m *PriceMutation) ClearBaseAsset() {
	...
	m.clearedFields[price.FieldBaseAssetID] = struct{}{}
}
...
func (m *PriceMutation) Fields() []string {
	...
	if m.asset != nil {
		fields = append(fields, price.FieldAssetID)
	}
	if m.base_asset != nil {
		fields = append(fields, price.FieldBaseAssetID)
	}
	if m.interval != nil {
		fields = append(fields, price.FieldInterval)
	}
	if m.decimals != nil {
		fields = append(fields, price.FieldDecimals)
	}
	if m.last != nil {
		fields = append(fields, price.FieldLast)
	}
	if m.open != nil {
	...
	if m.timestamp != nil {
		fields = append(fields, price.FieldTimestamp)
	}
	return fields
}
...
// SetData sets the "data" field.
func (m *TransactionMutation) SetData(value map[string]string) {
	m.data = &value
}

// Data returns the value of the "data" field in the mutation.
func (m *TransactionMutation) Data() (r map[string]string, exists bool) {
	v := m.data
	if v == nil {
		return
	}
...
// If the Transaction object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TransactionMutation) OldData(ctx context.Context) (v map[string]string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldData is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *UserMutation) SetPreferences(value map[string]string) {
	m.preferences = &value
}

// Preferences returns the value of the "preferences" field in the mutation.
func (m *UserMutation) Preferences() (r map[string]string, exists bool) {
	v := m.preferences
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldPreferences(ctx context.Context) (v map[string]string, err error) {
	if !m.op.Is(OpUpdateOne) {
