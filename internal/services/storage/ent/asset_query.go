...
func (aq *AssetQuery) QueryHoldings() *HoldingQuery {
...
func (aq *AssetQuery) WithHoldings(opts ...func(*HoldingQuery)) *AssetQuery {
	query := (&HoldingClient{config: aq.config}).Query()
...
func (aq *AssetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Asset, error) {
	...
	if query := aq.withHoldings; query != nil {
		if err := aq.loadHoldings(ctx, query, nodes,
			func(n *Asset) { n.Edges.Holdings = []*Holding{} },
			func(n *Asset, e *Holding) { n.Edges.Holdings = append(n.Edges.Holdings, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (aq *AssetQuery) loadHoldings(ctx context.Context, query *HoldingQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Holding)) error {
