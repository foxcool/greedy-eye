...
const (
	...
	// asset.
	//
	// Reported because the collapse of the two hid a live failure for months. A
	// USDT twin split the identity so that Binance quoted into one row while the
	// USDT/USD rate was written against the other; 74 holdings dropped out of the
	// total reading exactly like assets nobody had ever priced, which is what kept
	// anyone from looking.
...
type GetSweepScheduleRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional. Empty reports every source the instance can price with, which is
	// the question an operator actually has: a single frozen source is invisible
	// when you have to name it to see it.
	SourceId      *string `protobuf:"bytes,1,opt,name=source_id,json=sourceId,proto3,oneof" json:"source_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetSweepScheduleRequest) Reset() {
	*x = GetSweepScheduleRequest{}
	mi := &file_v1_marketdata_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetSweepScheduleRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSweepScheduleRequest) ProtoMessage() {}

func (x *GetSweepScheduleRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v1_marketdata_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSweepScheduleRequest.ProtoReflect.Descriptor instead.
func (*GetSweepScheduleRequest) Descriptor() ([]byte, []int) {
	return file_v1_marketdata_proto_rawDescGZIP(), []int{34}
}

func (x *GetSweepScheduleRequest) GetSourceId() string {
	if x != nil && x.SourceId != nil {
		return *x.SourceId
	}
	return ""
...
type GetSweepScheduleResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Sources       []*SourceSchedule      `protobuf:"bytes,1,rep,name=sources,proto3" json:"sources,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetSweepScheduleResponse) Reset() {
	*x = GetSweepScheduleResponse{}
	mi := &file_v1_marketdata_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetSweepScheduleResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSweepScheduleResponse) ProtoMessage() {}

func (x *GetSweepScheduleResponse) ProtoReflect() protoreflect.Message {
	mi := &file_v1_marketdata_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSweepScheduleResponse.ProtoReflect.Descriptor instead.
func (*GetSweepScheduleResponse) Descriptor() ([]byte, []int) {
	return file_v1_marketdata_proto_rawDescGZIP(), []int{35}
}

func (x *GetSweepScheduleResponse) GetSources() []*SourceSchedule {
	if x != nil {
		return x.Sources
	}
	return nil
...
type SourceSchedule struct {
	...
	Deferred       uint32                 `protobuf:"varint,3,opt,name=deferred,proto3" json:"deferred,omitempty"`
	NeverAttempted uint32                 `protobuf:"varint,4,opt,name=never_attempted,json=neverAttempted,proto3" json:"never_attempted,omitempty"`
	// When the earliest deferred asset comes due. Absent when nothing is
	// deferred, which is not the same as "due now" and must not render as one.
	SoonestDue *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=soonest_due,json=soonestDue,proto3,oneof" json:"soonest_due,omitempty"`
	// The far end of the queue. A latest_deferred a week out is the signature of
	// assets that have hit the back-off ceiling rather than drifted toward it.
	LatestDeferred *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=latest_deferred,json=latestDeferred,proto3,oneof" json:"latest_deferred,omitempty"`
	// The longest consecutive-miss streak against this source. It says how deep
	// the back-off has been driven, which no timestamp shows on its own.
	MaxMisses uint32 `protobuf:"varint,7,opt,name=max_misses,json=maxMisses,proto3" json:"max_misses,omitempty"`
	// Why the sweep would skip this source entirely, when it would: an exhausted
	// plan, a frozen bucket. Absent means the source would be asked. This is the
	// same judgement the sweep makes, read from the same provider, not a second
...
func (x *SourceSchedule) GetDueNow() uint32 {
	if x != nil {
		return x.DueNow
	}
	return 0
...
func (x *SourceSchedule) GetDeferred() uint32 {
	if x != nil {
		return x.Deferred
	}
	return 0
...
func (x *SourceSchedule) GetNeverAttempted() uint32 {
	if x != nil {
		return x.NeverAttempted
	}
	return 0
}

func (x *SourceSchedule) GetSoonestDue() *timestamppb.Timestamp {
	if x != nil {
		return x.SoonestDue
	}
	return nil
...
func (x *SourceSchedule) GetLatestDeferred() *timestamppb.Timestamp {
	if x != nil {
		return x.LatestDeferred
	}
	return nil
}

func (x *SourceSchedule) GetMaxMisses() uint32 {
	if x != nil {
		return x.MaxMisses
	}
	return 0
...
func (x *SourceSchedule) GetSkipReason() string {
...
const file_v1_marketdata_proto_rawDesc = "" +
	...
	"\bstatuses\x18\x01 \x03(\v2\x1a.eye.v1.AssetPricingStatusR\bstatuses\"I\n" +
	"\x17GetSweepScheduleRequest\x12 \n" +
	"\tsource_id\x18\x01 \x01(\tH\x00R\bsourceId\x88\x01\x01B\f\n" +
	"\n" +
	"_source_id\"L\n" +
	...
	"\bdeferred\x18\x03 \x01(\rR\bdeferred\x12'\n" +
	"\x0fnever_attempted\x18\x04 \x01(\rR\x0eneverAttempted\x12@\n" +
	"\vsoonest_due\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampH\x00R\n" +
	"soonestDue\x88\x01\x01\x12H\n" +
	"\x0flatest_deferred\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampH\x01R\x0elatestDeferred\x88\x01\x01\x12\x1d\n" +
	"\n" +
	"max_misses\x18\a \x01(\rR\tmaxMisses\x12$\n" +
	"\vskip_reason\x18\b \x01(\tH\x02R\n" +
	"skipReason\x88\x01\x01B\x0e\n" +
	"\f_soonest_dueB\x12\n" +
	"\x10_latest_deferredB\x0e\n" +
	"\f_skip_reason*\xb6\x01\n" +
	"\tAssetType\x12\x1a\n" +
