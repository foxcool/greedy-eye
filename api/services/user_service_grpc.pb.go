...
const (
	UserService_UpdateUserPreferences_FullMethodName = "/services.UserService/UpdateUserPreferences"
)
...
type UserServiceClient interface {
	...
	UpdateUserPreferences(ctx context.Context, in *UpdateUserPreferencesRequest, opts ...grpc.CallOption) (*models.User, error)
}
...
func (c *userServiceClient) UpdateUserPreferences(ctx context.Context, in *UpdateUserPreferencesRequest, opts ...grpc.CallOption) (*models.User, error) {
...
type UserServiceServer interface {
	// Updates user-specific preferences.
	UpdateUserPreferences(context.Context, *UpdateUserPreferencesRequest) (*models.User, error)
}
...
func (UnimplementedUserServiceServer) UpdateUserPreferences(context.Context, *UpdateUserPreferencesRequest) (*models.User, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/services/user_service.proto",
}
